...
public class ay8dashbourd extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ay8dashbourd);
    ...
    public void foto2(View view){
        Intent ıntent = new Intent(getApplicationContext(), ay8oyuncak.class);
        startActivity(ıntent);
    }
    public void foto3(View view){
        Intent ıntent = new Intent(getApplicationContext(), ay8asi.class);
        startActivity(ıntent);
