...
public class ay1dashbourd extends AppCompatActivity {
    ...
    public void foto2(View view){
        Intent ıntent = new Intent(getApplicationContext(), ay1oyuncak.class);
        startActivity(ıntent);
    }
    public void foto3(View view){
        Intent ıntent = new Intent(getApplicationContext(), ay1asi.class);
        startActivity(ıntent);

    }
    public void foto5(View view){
        Intent ıntent = new Intent(getApplicationContext(), ay1beslenme.class);
        startActivity(ıntent);
    }
